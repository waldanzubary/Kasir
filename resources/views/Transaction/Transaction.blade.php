...
<style>
    ...
    .card-header {
        background: #1a202c; /* Darker header background */
        padding: 10px;
        color: #e2e8f0;
        font-weight: bold;
    }
    ...
    .card-actions a:hover {
        background-color: #2d3748; /* Darker button color on hover */
    }
    ...
    @csrf
        <div class="stats shadow stats">
            <div class="stat">
                ...
                <div class="stat-title">Total Transaction</div>
