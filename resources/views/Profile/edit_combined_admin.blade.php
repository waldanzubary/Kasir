    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-8">
                ...
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-gray-600 mb-6">Admin Information</h2>
                    ...
                    <div class="mt-8 flex justify-end items-center">
                        <!-- Removed Extend Subscription Button -->
                ...
                <form method="POST" action="{{ route('profile.update_combined') }}" class="space-y-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-600 mb-6">Edit Admin Information</h2>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            @php
                                $shopFields = [
                                    'phone' => 'Phone',
