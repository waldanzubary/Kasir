...
<body class="index-page bg-base-100 flex flex-col min-h-screen">
    ...
    <section id="hero" class="hero-bg relative flex flex-col items-center justify-center text-center text-white h-screen">
        <div class="container mx-auto px-4 flex flex-col justify-center items-center animate-fadeInUp">
            <h1 class="text-3xl md:text-5xl font-bold mb-4">Welcome to UMKM Cashier!</h1>
            <p class="text-lg md:text-xl mb-6">Manage your UMKM store here!</p>
        </div>
    ...
    <section id="about" class="section py-12 md:py-20 bg-base-100">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-2xl md:text-3xl font-bold mb-8">About UMKM Cashier</h2>

            <div class="space-y-8">
                <!-- Product 1 -->
                <div class="flex flex-col md:flex-row items-center overflow-hidden p-4 md:p-6">
                    <img src="{{ asset('assets/img/about.png') }}" alt="Product 1"
                         class="w-full md:w-1/3 h-auto object-cover rounded-lg transition-transform duration-300 ease-in-out transform hover:scale-105 mb-4 md:mb-0">
                    <div class="mt-4 md:mt-0 md:ml-6 w-full md:w-2/3 text-left">
                        <h3 class="text-xl md:text-2xl font-semibold mb-2 text-black">Dashboard</h3>
                ...
                <!-- Product 2 -->
                <div class="flex flex-col md:flex-row items-center overflow-hidden p-4 md:p-6">
                    <div class="order-2 md:order-1 mt-4 md:mt-0 md:mr-6 w-full text-left md:w-2/3">
                        <h3 class="text-xl md:text-2xl font-semibold mb-2 text-black">Warehouse</h3>
                    ...
                    <img src="{{ asset('assets/img/about2.png') }}" alt="Product 2"
                         class="order-1 md:order-2 w-full md:w-1/3 h-auto object-cover rounded-lg transition-transform duration-300 ease-in-out transform hover:scale-105 mb-4 md:mb-0">
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center overflow-hidden p-4 md:p-6">
                    <img src="{{ asset('assets/img/about3.png') }}" alt="Product 3"
                         class="w-full md:w-1/3 h-auto object-cover rounded-lg transition-transform duration-300 ease-in-out transform hover:scale-105 mb-4 md:mb-0">
                    <div class="mt-4 md:mt-0 md:ml-6 w-full md:w-2/3 text-left">
                        <h3 class="text-xl md:text-2xl font-semibold mb-2 text-black">Create a sale!</h3>
    ...
    <div class="flex justify-center">
        ...
        <div class="flex flex-row justify-center">
            ...
            <ul class="timeline flex flex-col lg:flex-row lg:justify-between space-y-8 lg:space-y-0 lg:space-x-4">
            <li>
