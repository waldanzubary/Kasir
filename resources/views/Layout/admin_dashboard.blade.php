    ...
    <div class="flex flex-col lg:flex-row min-h-screen">
            ...
            <div class="h-full p-3 space-y-2 w-60 bg-white">
                ...
                <div class=" ">
                    <ul class="pt-2 pb-4 space-y-1 text-sm">
                        <li class="">
                            <a rel="noopener noreferrer" href="/dashboard" class="flex items-center p-2 space-x-3 rounded-md {{ request()->is('dashboard') ? 'bg-blue-100' : '' }}">
                                <i class="fa-solid fa-chart-line sidebar-item-icon text-xl" style="color: #6bac74;"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="/manage" class="flex items-center p-2 space-x-3 rounded-md {{ request()->is('manage') ? 'bg-blue-100' : '' }}">
        ...
        <div class="flex-1 content">
            ...
            <nav class="bg-transparent p-5">
                <!-- You can add navigation links, buttons, or logos here in the future -->
            </nav>
